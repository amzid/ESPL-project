...
int main()
{
    ...
    Game game = {NOT_CONNECTED, START_MENU, SINGLE_MODE, NOT_CHOSEN, SPEED_CTRL, INDEX_MAP_2, {&road[0],&road[1],&road[2]}, &ego, &bot[0], &bot[1], &bot[2], {&map[0],&map[1],&map[2]}, START_MENU, 0, 0,1,1,MULTIPLAYER_MODE};
    ...
    xTaskCreate(uartReceive, "uartReceive", STACK_SIZE, &game, 6, &receiveHdl);
